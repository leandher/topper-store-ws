...
public class ItemService {
	...
	/*
	 * public List<Item> getItensDoProduto(Integer idProduto) { return
	 * produtoRepository.findOne(idProduto).getItens(); }
	 * 
	 * public Item getItemDoProduto(Integer idItem) { return
	 * itemRepository.findItemDoProduto(idItem); }
	 * 
	 * public void addItemNoProduto(Integer idProduto, Item item) { Produto
	 * produto = produtoRepository.findOne(idProduto);
	 * produto.getItens().add(item); produtoRepository.save(produto); }
	 */
}
