...
public class ItemController {
	...
	/*
	 * @RequestMapping("/itensDoProduto/{idProduto}") public List<Item>
	 * getAllItensDoProduto(@PathVariable Integer idProduto) { return
	 * produtoService.getProduto(idProduto).getItens(); }
	 * 
	 * @RequestMapping("/itemDoProduto/{idItem}") public Item
	 * getItemDoProduto(@PathVariable Integer idItem) { return
	 * itemService.getItemDoProduto(idItem); }
	 * 
	 * @RequestMapping(method=RequestMethod.POST, value="/{idPedido}") public
	 * void addItemNoPedido(@RequestBody Item item, @PathVariable Integer
	 * idPedido) { itemService.addItemNoPedido(idPedido, item); }
	 * 
	 * @RequestMapping(method=RequestMethod.POST, value="/{idProduto}") public
	 * void addItemNoProduto(@RequestBody Item item, @PathVariable Integer
	 * idProduto) { itemService.addItemNoProduto(idProduto, item); }
	 */
}
